...
input_folder = '/data/backup2/Yuni/CRC_Liver/00_SVS_images/04_multi_regions/CRC_LM_10/'
output_folder = '/data/backup/Yuni/CRC_Liver/01_tiles_output/04_tiles_output/'
output_folder2 = '/data/backup2/Yuni/CRC_Liver/01_tiles_output/04_tiles_output/'
output_folder3 = '/dataserver145/image/Yuni/CRC_Liver/01_tiles_output/04_tiles_output/'
...
def wrapper(image_name):
    ...
    output_folder1=output_folder3+subfolder
    ...
    for res in results:
        if res is not None:
            images.append(res[1])
            tilesN.append(res[0])
    f=open(f'{output_folder3}{Name}.pkl','wb')
