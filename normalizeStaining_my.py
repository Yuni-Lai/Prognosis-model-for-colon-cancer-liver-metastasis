...
def normalizeStaining_my(img, savePath=None, Io=255, alpha=1, beta=0.15): # previous Io 240
   ...
   # H[H>255] = 254
    ...
    if savePath is not None:
        Image.fromarray(Inorm).save(savePath, quality=95, subsampling=0)
    else:
        return Inorm
